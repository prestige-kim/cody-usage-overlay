...
Cody가 움직이면 함께 따라가고, 작업 알림이 뜨면 반대편으로 자리를 옮깁니다. Cody를 찾지 못했을 때는 일반 창처럼 드래그해서 쓸 수 있습니다.
...
- 다시 보려면 Codex에서 펫을 숨겼다가 표시하세요.
- 우클릭 메뉴에서 새로고침, 위치 재탐색, 항상 위, 진단 정보 복사, 종료를 선택할 수 있습니다.
