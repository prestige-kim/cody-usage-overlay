...
if ($codex) {
    ...
    try {
        [void]$server.Start()
        $server.StandardInput.WriteLine('{"id":1,"method":"initialize","params":{"clientInfo":{"name":"cody-usage-overlay-doctor","title":"Cody Usage Overlay Doctor","version":"0.3.0"},"capabilities":{"experimentalApi":true}}}')
